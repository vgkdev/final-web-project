...
const PersonalCare = () => {
  ...
  useEffect(() => {
    const personalCareProducts = categories.find(
      (category) => category.categoryName === "Sản phẩm chức năng"
    );
    if (personalCareProducts) {
      setProducts(personalCareProducts.Products || []);
      setLoading(false);
    }
  }, [categories]);
